...
export default function IntelligentDashboard() {
  ...
  // ⬇️ Muncul saat mendekati viewport (atas/bawah), hilang saat keluar area pantau
  const { ref, visible } = useApproachReveal({
    amount: 0.3,                 // 30% elemen terlihat → dianggap "in view"
    rootMargin: "-12% 0px -12% 0px", // area buffer atas & bawah biar smooth
  });
    ...
    <section id="unik" className="py-16 sm:py-20">
      <div className="wrap">
        <motion.div
          ...
          className={`rounded-3xl border overflow-hidden shadow-sm transition-[pointer-events] duration-200
