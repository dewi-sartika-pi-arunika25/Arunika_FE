...
import { CheckCircle2, TrendingUp, ArrowUpRight, BookOpen, Loader, AlertCircle } from "lucide-react";
      ...
      <div className="p-8 pt-24 flex items-center justify-center min-h-screen">
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600">Menganalisis profil Anda...</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <div className="p-8 pt-24">
        <Card className="border-red-300 bg-red-50">
          <CardContent className="p-4 text-red-700 flex items-start gap-2">
            ...
            <div>{error || "Gagal memuat analisis"}</div>
          </CardContent>
        </Card>
      </div>
    );
        ...
        <div className="space-y-4">
          <div className="p-3 bg-[#FFF6DC] rounded-lg border border-[#E4B200]/30">
            <p className="text-sm text-[#2C2C2C]">
              <span className="font-semibold">Level Saat Ini:</span> {profile.level}
            </p>
          </div>
          <div className="p-3 bg-[#FFF6DC] rounded-lg border border-[#E4B200]/30">
            <p className="text-sm text-[#2C2C2C]">
              <span className="font-semibold">Target Pengembangan:</span> {profile.gap}
            </p>
          </div>
          <div className="p-3 bg-[#FFF6DC] rounded-lg border border-[#E4B200]/30">
            <p className="text-sm text-[#2C2C2C]">
              <span className="font-semibold">Status:</span> {profile.role_fit}
            </p>
          </div>
        </div>
      </Card>
